                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              <img alt="" height="auto" src="{{ asset('main_page/images/logo_nomads@2x.png') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <div style="font-family:Assistant, Helvetica, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071C4D;">Hi, {{ $data->user->name }} <br><br> Tiket digital kamu sudah berhasil dicetak. <br> Booking ID <strong>#{{ $data->id }}</strong>
                                <br>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Helvetica, sans-serif;font-size:18px;line-height:30px;table-layout:auto;width:100%;border:none;">
                                <tr>
          ...
          <![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                ...
                font-family: Assistant, Helvetica, Arial, sans-serif">Butuh Bantuan?</td>
                        ...
                        <tr>
                          <td style="width: 50px">
                            <img src="{{ asset('main_page/images/ic_support@2x.png') }}" width="50px">
                          </td>
